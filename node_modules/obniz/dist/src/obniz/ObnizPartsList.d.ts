...
export interface PartsList {
    ...
    "FullColorLED": {
        class: FullColorLED;
        options: FullColorLEDOptions;
    };
    "WS2811": {
        class: WS2811;
        options: WS2811Options;
    };
    "WS2812": {
        class: WS2812;
        options: WS2812Options;
    };
    "WS2812B": {
        class: WS2812B;
        options: WS2812BOptions;
    };
    "InfraredLED": {
        class: InfraredLED;
        options: InfraredLEDOptions;
    };
    "IRSensor": {
        class: IRSensor;
        options: IRSensorOptions;
    };
    "IRModule": {
        class: IRModule;
        options: IRModuleOptions;
    };
    "7SegmentLED": {
        class: _7SegmentLED;
        options: _7SegmentLEDOptions;
    };
    "7SegmentLEDArray": {
    ...
    "SharpMemoryTFT": {
        ...
        options: SharpMemoryTFTOptions;
    };
    "ST7735S": {
        class: ST7735S;
        options: ST7735SOptions;
    };
    "ArduCAMMini": {
        class: ArduCAMMini;
        options: ArduCAMMiniOptions;
    };
    "JpegSerialCam": {
        class: JpegSerialCam;
        options: JpegSerialCamOptions;
    };
    "DCMotor": {
        class: DCMotor;
        options: DCMotorOptions;
    };
    "PCA9685": {
        class: PCA9685;
    ...
    "ServoMotor": {
        class: ServoMotor;
        options: ServoMotorOptions;
    };
    "Solenoid": {
        class: Solenoid;
        options: SolenoidOptions;
    };
    "StepperMotor": {
        class: StepperMotor;
        options: StepperMotorOptions;
    };
    "Speaker": {
        class: Speaker;
    ...
    "MQ135": {
        class: MQ135;
        options: MQ135Options;
    };
    "SNx4HC595": {
        class: SNx4HC595;
        options: SNx4HC595Options;
    };
    "USB": {
        class: USB;
        options: USBOptions;
    ...
    "AK8963": {
        class: AK8963;
        options: AK8963Options;
    };
    "MPU6050": {
        class: MPU6050;
        options: MPU6050Options;
    };
    "MPU6500": {
        class: MPU6500;
        options: MPU6500Options;
    };
    "MPU6886": {
        class: MPU6886;
        options: MPU6886Options;
    };
    "MPU9250": {
        class: MPU9250;
        options: MPU9250Options;
    };
    "SH200Q": {
        class: SH200Q;
        options: SH200QOptions;
    };
    "AK09916": {
        class: AK09916;
        options: AK09916Options;
    };
    "ICM20948": {
        class: ICM20948;
        options: ICM20948Options;
    };
    "HC-SR505": {
        class: HCSR505;
        options: HCSR505Options;
    };
    "JoyStick": {
        class: JoyStick;
    ...
    "KXR94-2050": {
        class: KXR94_2050;
        options: KXR94_2050Options;
    };
    "IPM-165": {
        class: IPM_165;
        options: IPM_165Options;
    };
    "PaPIRsVZ": {
        class: PaPIRsVZ;
        options: PaPIRsVZOptions;
    };
    "Potentiometer": {
        class: Potentiometer;
        options: PotentiometerOptions;
    };
    "ENC03R_Module": {
        class: ENC03R_Module;
        options: ENC03R_ModuleOptions;
    };
    "FSR40X": {
        class: FSR40X;
        options: FSR40XOptions;
    };
    "HC-SR04": {
        class: HCSR04;
        options: HCSR04Options;
    };
    "GP2Y0A21YK0F": {
        class: GP2Y0A21YK0F;
        options: GP2Y0A21YK0FOptions;
    };
    "VL53L0X": {
        class: VL53L0X;
        options: VL53L0XOptions;
    };
    "GYSFDMAXB": {
        class: GYSFDMAXB;
        options: GYSFDMAXBOptions;
    };
    "CT10": {
        class: CT10;
        options: CT10Options;
    ...
    "HMC5883L": {
        class: HMC5883L;
        options: HMC5883LOptions;
    };
    "hx711": {
        class: HX711;
        options: Hx711Options;
    };
    "MCP4725": {
        class: MCP4725;
        options: MCP4725Options;
    };
    "SEN0114": {
        class: SEN0114;
        options: SEN0114Options;
    };
    "LM35DZ": {
        class: LM35DZ;
        options: LM35DZOptions;
    };
    "LM60": {
        class: LM60;
        options: LM60Options;
    ...
    "LMT87": {
        class: LMT87;
        options: LMT87Options;
    };
    "MCP9700": {
        class: MCP9700;
        options: MCP9700Options;
    };
    "MCP9701": {
        class: MCP9701;
        options: MCP9701Options;
    };
    "AMG8833": {
        class: AMG8833;
        options: AMG8833Options;
    };
    "BME280": {
        class: BME280;
    ...
    "D6T44L": {
        class: D6T44L;
        options: D6T44LOptions;
    };
    "DHT12": {
        class: DHT12;
        options: DHT12Options;
    };
    "SHT31": {
        class: SHT31;
        options: SHT31Options;
    };
    "SHT20": {
        class: SHT20;
    ...
    "ADT7310": {
        class: ADT7310;
        options: ADT7310Options;
    };
    "AM2320": {
        class: AM2320;
        options: AM2320Options;
    };
    "PT550": {
        class: PT550;
        options: PT550Options;
    };
    "S11059": {
        class: S11059;
        options: S11059Options;
    };
    "YG1006": {
        class: YG1006;
        options: YG1006Options;
    };
    "Grove_Button": {
        class: Grove_Button;
        options: Grove_ButtonOptions;
    };
    "Grove_Buzzer": {
        class: Grove_Buzzer;
        options: Grove_BuzzerOptions;
    };
    "Grove_EarHeartRate": {
    ...
    "Grove_MP3": {
        class: Grove_MP3;
        options: Grove_MP3Options;
    };
    "Grove_GPS": {
        class: Grove_GPS;
        options: Grove_GPSOptions;
    };
    "Grove_EARTH": {
        class: Grove_EARTH;
        options: Grove_EARTHOptions;
    };
    "Grove_JoyStick": {
        class: Grove_JoyStick;
        options: Grove_JoyStickOptions;
    };
    ...
    "M5StickC_ADC": {
        class: M5StickC_ADC;
        options: M5StickC_ADCOptions;
    };
    "M5StickC_DAC": {
        class: M5StickC_DAC;
        options: M5StickC_DACOptions;
    };
    "M5StickC_ToF": {
        class: M5StickC_ToF;
        options: M5StickC_ToFOptions;
    };
    "M5StickC_FINGER": {
        class: M5StickC_FINGER;
        options: M5StickC_FINGEROptions;
    };
    "M5StickC_RS485": {
        class: M5StickC_RS485;
        options: M5StickC_RS485Options;
    };
    "M5StickC_Yun": {
        class: M5StickC_Yun;
        options: M5StickC_YunOptions;
    };
    "Keyestudio_Button": {
    ...
    "2JCIE": {
        class: OMRON_2JCIE;
        options: OMRON_2JCIEOptions;
    };
    "Logtta_CO2": {
        class: Logtta_CO2;
        options: Logtta_CO2Options;
    };
    "Logtta_TH": {
        class: Logtta_TH;
        options: Logtta_THOptions;
    };
    "Logtta_AD": {
        class: Logtta_AD;
        options: Logtta_ADOptions;
    };
    "Logtta_Accel": {
        class: Logtta_Accel;
        options: Logtta_AccelOptions;
    };
    "Linking": {
        class: Linking;
    ...
    "RS_Seek3": {
        class: RS_Seek3;
        options: RS_Seek3Options;
    };
    "REX_BTPM25V": {
        class: REX_BTPM25V;
        options: REX_BTPM25VOptions;
    };
    "PLS_01BT": {
        class: PLS_01BT;
        options: PLS_01BTOptions;
    };
    "ENERTALK_TOUCH": {
    ...
    "MiniBreeze": {
        class: MiniBreeze;
        options: MiniBreezeOptions;
    };
    "MT_500BT": {
        class: MT_500BT;
        options: MT_500BTOptions;
    };
    "PULSE08_M5STICKC-S": {
    ...
    "24LC256": {
        class: _24LC256;
        options: _24LC256Options;
    };
    "FlickHat": {
        class: FlickHat;
        options: FlickHatOptions;
    };
    "KXSC7_2050": {
        class: KXSC7_2050;
        options: KXSC7_2050Options;
    };
    "S8100B": {
        class: S8100B;
        options: S8100BOptions;
    };
    "S8120C": {
        class: S8120C;
        options: S8120COptions;
    };
    "ADT7410": {
        class: ADT7410;
        options: ADT7410Options;
    };
    "S5851A": {
        class: S5851A;
        options: S5851AOptions;
    };
    "DPS310": {
        class: DPS310;
        options: DPS310Options;
    };
    "BMP280": {
        class: BMP280;
        options: BMP280Options;
    };
    "HEM_9200T": {
        class: HEM_9200T;
